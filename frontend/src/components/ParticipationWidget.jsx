  ...
  return (
      <div className="card bg-white shadow-md rounded-lg max-h-[220px]">
        <div className="card-body p-4">
          ...
          <button className={`px-4 py-2 rounded-lg text-white font-semibold ${!joined ? 'bg-violet-500' : 'bg-gray-500'} hover:bg-violet-600 transition-colors duration-300`} onClick={onJoin}>Join Event</button>
        </div>
      </div>
  );
};
