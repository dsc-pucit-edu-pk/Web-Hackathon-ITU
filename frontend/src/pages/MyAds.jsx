...
export default function MyAds({ setProgress }) {
  ...
  return (
    <div className={"min-h-[70vh] pt-10"}>
      <h3 className='text-3xl font-medium text-center sm:text-left'>My Ads</h3>
      <div className="mt-4">
        {loading &&
          ...
          places.map((place) => (
            ...
            >
              ...
              <div className="ml-auto md:relative right-4 absolute">
                <AdDrawer ad={place} setAds={setPlaces} />
              </div>
            </div>
          ))}
